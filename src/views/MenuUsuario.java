...
public class MenuUsuario extends JFrame {
	...
	public MenuUsuario() {
		...
		lblBusquedaDeReservas.setIcon(new ImageIcon(Objects.requireNonNull(MenuUsuario.class.getResource("/imagens/pessoas.png"))));
		...
		panelMenu.add(logo);
		logo.setIcon(new ImageIcon(Objects.requireNonNull(MenuUsuario.class.getResource("/imagens/aH-150px.png"))));
		...
		labelRegistro.setIcon(new ImageIcon(Objects.requireNonNull(MenuUsuario.class.getResource("/imagens/reservado.png"))));
        ...
        btnSair.setBounds(80, 450, 70, 70);
        ...
        imageSair.setHorizontalAlignment(SwingConstants.LEFT);

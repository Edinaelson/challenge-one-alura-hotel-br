...
public class Login extends JFrame {
	...
	public Login() {
		...
		imgHotel.setIcon(new ImageIcon(Objects.requireNonNull(Login.class.getResource("/imagens/img-hotel-login-.png"))));
		...
		logo.setIcon(new ImageIcon(Objects.requireNonNull(Login.class.getResource("/imagens/LOGO-50PX.png"))));
